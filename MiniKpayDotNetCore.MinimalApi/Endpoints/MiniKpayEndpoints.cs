...
using MiniKpayDotNetCore.MinimalApi.Services;

namespace MiniKpayDotNetCore.MinimalApi.Endpoints;

public static class MiniKpayEndpoints
{
    
    
        public static void MapKPayEndpoints(this IEndpointRouteBuilder app)
        {
            MiniKpayServices _services = new MiniKpayServices();
